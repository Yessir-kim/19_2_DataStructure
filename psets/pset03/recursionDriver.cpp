...
Signed: 김영빈 Section: pset03 Student Number: 21600108
*/
...
int main(int argc, char *argv[]) {
	...
	while(1) {
		...
		case 7:
			cout << "\tsumDigits(1) = 1\n";
			cout << "\tsumDigits(122) = 5\n";
			cout << "\tsumDigits(1234) = 10\n";
			cout << "\tsumDigits(2453) = 14\n";
			cout << "\tsumDigits(440440) = 16\n";
			while (1) {
